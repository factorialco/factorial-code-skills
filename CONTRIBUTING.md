...
| Concept | Owner |
|---|---|
| Platform model: processes, modules, execution context, variables, the inheritance model (processes, modules, variables, locales, dependencies), datastore vs storage, versioning & alias model | `fcode-core-concepts` |
